...
const en = {
  ...
  requestTimeoutHint: 'Abort request after this time. Default: 300000ms (5 min). Gemini 65K output may need 3-5 min.',
...
const vi: TranslationKeys = {
  ...
  requestTimeoutHint: 'Hủy yêu cầu sau thời gian này. Mặc định: 300000ms (5 phút). Gemini 65K output cần 3-5 phút.',
