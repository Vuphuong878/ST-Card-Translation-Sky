...
export default function TemplateTranslatorPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-zinc-950 text-zinc-50 flex flex-col p-6 md:p-8 lg:p-12 select-none">
      ...
      <main className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch flex-1">
        ...
        <section className="lg:col-span-5 flex flex-col gap-6">
          ...
          <div className="bg-zinc-900/40 border border-zinc-800/60 rounded-xl p-5 backdrop-blur-md">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Languages */}
              <div className="grid grid-cols-2 gap-3 border-t border-zinc-800/50 pt-4 mt-1">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-mono tracking-wider text-zinc-400 uppercase">Nguồn</label>
                  <input
                    type="text"
                    value={sourceLang}
                    onChange={(e) => setSourceLang(e.target.value)}
                    className="bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-200 focus:outline-none"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-mono tracking-wider text-zinc-400 uppercase">Đích</label>
                  <input
                    type="text"
                    value={targetLang}
